    ...
    <html lang="en"> 
        ...
        <body class="w-full h-screen flex flex-col flex-1">
            ...
            <div class="mt-16 h-full border flex items-center justify-center">
                <form class="w-1/3" action="/signup" method="post">
                    <div class="text-center text-2xl font-medium mb-10">SIGNUP</div>
                    @csrf
                    <div class="flex flex-col  border rounded-lg p-10 gap-4">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input name="phoneno" id="phoneno" class=" rounded-md p-2 border-2 border-gray-900/10 focus:ring-0 focus:border-gray-500" type="text" placeholder="Phone no" required>
                        </div>
                        <div class="flex flex-col gap-2">
