    ...
    <html lang="en"> 
        ...
        <body class="w-full h-screen flex flex-col flex-1">
            ...
            <div class="mt-16 h-full border flex items-center justify-center">
                <form class="w-1/3" action="login" method="post">
                    <div class="text-center text-2xl font-medium mb-10">LOGIN</div>
                    @csrf
                    <div class="flex flex-col  border rounded-lg p-10 gap-4">
                        ...
                        <div class="text-center">
                            Don't have an account ? <span>
                                <a class="text-blue-500" href="/register">
                                    Register
                                </a>
                            </span>
                        </div>
